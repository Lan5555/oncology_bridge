    ...
    <>
      <nav className={styles['nav'] + (scrolled ? ' ' + styles['scrolled'] : '')} id="mainNav">
        ...
        <div className={styles['nav-cta']}>
          <button className={styles['btn-nav'] + ' ' + styles['ghost']} onClick={() => router.push('/pages/dashboard')}>
            Sign In
          </button>
          <button className={styles['btn-nav'] + ' ' + styles['solid']} onClick={() => router.push('/pages/dashboard')}>
            Request Access
          </button>
        </div>
